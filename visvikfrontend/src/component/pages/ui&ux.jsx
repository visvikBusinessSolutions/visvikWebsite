...
const UI = () => {
  return (
    <div className="">
      <div className="bg-[#eef1f9] py-6 px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="./pages_images/ux&ui-banner.png"
      ...
      <ContactSection
        tittle="Ready to elevate your user experience with top-notch UI/UX design? Get in Touch with Us!"
        paragraph="We build designs that captivate, engage, and convert your vision into reality."
      />
